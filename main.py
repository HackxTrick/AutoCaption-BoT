...
about_message = """
<b>• Name : [ ˹ Aᴜᴛᴏ ᴄᴀᴘᴛɪᴏɴ ✘ Aᴋᴀɴᴇ ˼ ](t.me/{username})</b>
<b>• Developer : [AKANE BF](https://t.me/ANIME_TIMETV)
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/GAURAV_BOTS>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/GAURAV_BOTS"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Aᴅᴅ Tᴏ Yᴏᴜʀ Cʜᴀɴɴᴇʟ ➕️", url=f"http://t.me/{bot.username}?startchannel=true")
   ]]
...
print("Telegram  ˹ Aᴜᴛᴏ ᴄᴀᴘᴛɪᴏɴ ✘ Aᴋᴀɴᴇ ˼ Bot Start")
print("Bot Created By https://t.me/ANIME_TIMETV")
